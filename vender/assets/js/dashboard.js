    ...
    $(function () {
        if ($(".dashboard-progress-1").length) {
            $('.dashboard-progress-1').circleProgress({
                value: 0, size: 125, thickness: 7, startAngle: 10, fill: {
        ...
        if ($(".dashboard-progress-1-dark").length) {
            $('.dashboard-progress-1-dark').circleProgress({
                value: 0, size: 125, thickness: 7, startAngle: 10, emptyFill: '#eef0fa', fill: {
                    gradient: ["#7922e5", "#1579ff"]
                }
            });
        }
        ...
        if ($("#total-expences-dark").length) {
                ...
                scales: {
                    yAxes: [{
                        display: false, gridLines: {
                            drawBorder: false, display: false, drawTicks: false
                        }, ticks: {
            ...
            var barChart = new Chart(barChartCanvas, {
                type: 'line', data: totalExpencesDarkData, options: totalExpencesDarkOptions,
            });
        }

        if ($("#device-sales").length){
            getApi(url_api + "device/countDevicesMonth").then(data => {
                console.log(data);

                let dataMake = data.data['make'];
                let dataSold = data.data['active'];
                let all_key = data.data['all_key'];
                let sum = data.data['sum'];
                let user = data.data['user'];

                if ($("#device-sales").length) {
                    var deviceSalesData = {
                        labels: all_key ?? [], datasets: [{
                            label: 'Thiết bị sản xuất',
                            data: dataMake.value ?? [],
                            backgroundColor: ['#a461d8', '#a461d8', '#a461d8', '#a461d8', '#a461d8', '#a461d8', '#a461d8', '#a461d8',],
                            borderColor: ['#a461d8', '#a461d8', '#a461d8', '#a461d8', '#a461d8', '#a461d8', '#a461d8', '#a461d8',],
                            borderWidth: 1,
                            fill: false
                        }, {
                            label: 'Thiết bị kích hoạt',
                            data: dataSold.value ?? [],
                            backgroundColor: ['#fc5a5a', '#fc5a5a', '#fc5a5a', '#fc5a5a', '#fc5a5a', '#fc5a5a', '#fc5a5a', '#fc5a5a',],
                            borderColor: ['#fc5a5a', '#fc5a5a', '#fc5a5a', '#fc5a5a', '#fc5a5a', '#fc5a5a', '#fc5a5a', '#fc5a5a',],
                            borderWidth: 1,
                            fill: false
                        }]
                    };
                    ...
                    // This will get the first returned node in the jQuery collection.
                    var barChart = new Chart(barChartCanvas, {
                        type: 'bar', data: deviceSalesData, options: deviceSalesOptions
                    });
                ...
                if ($("#total-profit").length) {
                    ...
                    // This will get the first returned node in the jQuery collection.
                    var barChart = new Chart(barChartCanvas, {
                        type: 'line', data: totalProfitData, options: totalProfitOptions,
                    });
                }
        ...
        if ($("#total-profit-dark").length) {
            ...
            var totalProfitDarkOptions = {
                scales: {
                    yAxes: [{
                        display: false, gridLines: {
                            drawBorder: false, display: false, drawTicks: false, zeroLineColor: 'rgba(90, 113, 208, 0)',
                        }, ticks: {
                            beginAtZero: true, stepSize: 10,
                        }
                    }], xAxes: [{
            ...
            // This will get the first returned node in the jQuery collection.
            var barChart = new Chart(barChartCanvas, {
                type: 'line', data: totalProfitDarkData, options: totalProfitDarkOptions,
            });
        }

        if ($("#device-sales-dark").length) {
            var deviceSalesDarkData = {
                labels: ["Iphone", "Google", "Sumsung", "Huawei", "Xiaomi", "Oppo", "Vivo", "Lg"], datasets: [{
                    label: 'Thiết bị sản xuất',
            ...
            var deviceSalesDarkOptions = {
                scales: {
                    xAxes: [{
                        ...
                        ticks: {
                            display: true, //this will remove only the label
                            stepSize: 500, fontColor: "#3a3a43", fontSize: 14, padding: 10,
                        }
                    }], yAxes: [{
                        stacked: false, display: true, gridLines: {
                            drawBorder: false,
            ...
            // This will get the first returned node in the jQuery collection.
            var barChart = new Chart(barChartCanvas, {
                type: 'bar', data: deviceSalesDarkData, options: deviceSalesDarkOptions
            });
            document.getElementById('device-sales-legend').innerHTML = barChart.generateLegend();
        }
        ...
        if ($("#account-retension").length) {
            var accountRetensionData = {
                labels: ["Jan", "Feb", "Mar", "Apr", "May"], datasets: [{
                    label: 'Thiết bị sản xuất',
                    data: [33, 48, 39, 36, 36],
                    backgroundColor: ['#d8d8d8', '#d8d8d8', '#d8d8d8', '#d8d8d8', '#d8d8d8',],
            ...
            // This will get the first returned node in the jQuery collection.
            var barChart = new Chart(barChartCanvas, {
                type: 'bar', data: accountRetensionData, options: accountRetensionOptions
            });
        }
        ...
        if ($("#page-view-analytic").length) {
                ...
                scales: {
                    yAxes: [{
                        display: true, gridLines: {
                            ...
                            beginAtZero: true, stepSize: 50, display: true, padding: 10,
                        }
                    }], xAxes: [{
                        display: true, position: 'bottom', gridLines: {
                            drawBorder: false, display: false, drawTicks: false,
                        }, ticks: {
                            beginAtZero: true, stepSize: 10, fontColor: "#a7afb7", padding: 10,
                        }
                    }],
                }, legend: {
                    display: false,
            ...
            // This will get the first returned node in the jQuery collection.
            var barChart = new Chart(barChartCanvas, {
                type: 'line', data: pageiVewAnalyticData, options: pageiVewAnalyticOptions,
            });
        ...
        if ($("#page-view-analytic-dark").length) {
                ...
                scales: {
                    yAxes: [{
                        display: true, gridLines: {
                            ...
                            beginAtZero: true, stepSize: 50, display: true, padding: 10, fontColor: '#3a3a43'
                        }
                    }], xAxes: [{
                        display: true, position: 'bottom', gridLines: {
                            drawBorder: false, display: false, drawTicks: false,
                        }, ticks: {
                            beginAtZero: true, stepSize: 10, fontColor: "#3a3a43", padding: 10,
                        }
                    }],
                }, legend: {
                    display: false,
            ...
            // This will get the first returned node in the jQuery collection.
            var barChart = new Chart(barChartCanvas, {
                type: 'line', data: pageiVewAnalyticDarkData, options: pageiVewAnalyticDarkOptions,
            });
            document.getElementById('pageViewAnalyticLengend').innerHTML = barChart.generateLegend();
        }
        ...
        if ($("#my-balance").length) {
            var myBalanceData = {
                labels: ["Jan", "Feb", "Mar", "Apr"], datasets: [{
                    label: 'Thiết bị sản xuất',
                    data: [90, 85, 100, 105],
            ...
            var myBalanceOptions = {
                scales: {
                    xAxes: [{
                        stacked: true, barPercentage: .7, position: 'bottom', display: true, gridLines: {
                            display: false, drawBorder: false, drawTicks: false
                        }, ticks: {
                            display: true, //this will remove only the label
                            stepSize: 500, fontColor: "#111", fontSize: 12, padding: 10,
                        }
                    }], yAxes: [{
                        stacked: false, display: false, gridLines: {
                            drawBorder: true,
                            display: false,
                            color: "#eef0fa",
                            drawTicks: false,
            ...
            // This will get the first returned node in the jQuery collection.
            var barChart = new Chart(barChartCanvas, {
                type: 'bar', data: myBalanceData, options: myBalanceOptions
            });
        }
        ...
        if ($("#my-balance-dark").length) {
            var myBalanceDarkData = {
                labels: ["Jan", "Feb", "Mar", "Apr"], datasets: [{
                    ...
                    label: 'Thiết bị kích hoạt',
                    data: [200, 200, 200, 200],
                    backgroundColor: ['#2b2b36', '#2b2b36', '#2b2b36', '#2b2b36',],
                    borderColor: ['#2b2b36', '#2b2b36', '#2b2b36', '#2b2b36',],
                    borderWidth: 1,
                    fill: false
                }]
            };
                ...
                scales: {
                    xAxes: [{
                        stacked: true, barPercentage: .7, position: 'bottom', display: true, gridLines: {
                            ...
                            display: true, //this will remove only the label
                            stepSize: 500, fontColor: "#fff", fontSize: 12, padding: 10,
                        }
                    }], yAxes: [{
                        stacked: false, display: false, gridLines: {
                            drawBorder: true,
            ...
            // This will get the first returned node in the jQuery collection.
            var barChart = new Chart(barChartCanvas, {
                type: 'bar', data: myBalanceDarkData, options: myBalanceDarkOptions
            });
        }
        ...
        if ($("#prediction-1").length) {
            ...
            // This will get the first returned node in the jQuery collection.
            var barChart = new Chart(barChartCanvas, {
                type: 'line', data: prediction1Data, options: prediction1Options,
            });
        }
        if ($("#prediction-1-dark").length) {
            ...
            // This will get the first returned node in the jQuery collection.
            var barChart = new Chart(barChartCanvas, {
                type: 'line', data: prediction1DataDark, options: prediction1OptionsDark,
            });
        }
        ...
        if ($("#prediction-2-dark").length) {
            ...
            // This will get the first returned node in the jQuery collection.
            var barChart = new Chart(barChartCanvas, {
                type: 'line', data: prediction2DataDark, options: prediction2OptionsDark,
        ...
        if ($("#prediction-3-dark").length) {
            ...
            // This will get the first returned node in the jQuery collection.
            var barChart = new Chart(barChartCanvas, {
                type: 'line', data: prediction3DataDark, options: prediction3OptionsDark,
            });
        }
        ...
        if ($("#prediction-4-dark").length) {
            ...
            // This will get the first returned node in the jQuery collection.
            var barChart = new Chart(barChartCanvas, {
                type: 'line', data: prediction4DataDark, options: prediction4OptionsDark,
            });
        }
