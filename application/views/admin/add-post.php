...
<div class="d-xl-flex justify-content-between align-items-start">
    <div style="display: flex; margin: 0px">
        <h3 class="text-dark font-weight-bold mb-2" id="page-title">Thêm bài viết mới</h3>
...
<script>
    ...
    async function addPostContent(){
        ...
        callApiPost(api_add, data).then(e => {
            alert(e.message);
            if (e.status){
